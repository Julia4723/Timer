...
//этот класс надо доработать так, чтобы можно было использовать для валидации внесенных данных на экране логина
...
final class UserManager: ObservableObject {
    ...
    //var name = "" //в домашке создать модель данных в которой будет свойство name
